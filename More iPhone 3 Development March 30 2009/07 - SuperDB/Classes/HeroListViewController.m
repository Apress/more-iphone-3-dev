...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    switch (tab) {
        ...
        case kByName: {
            NSSortDescriptor *sortDescriptor1 = [[NSSortDescriptor alloc] initWithKey:@"name" ascending:YES selector:@selector(localizedCaseInsensitiveCompare:)];
            NSSortDescriptor *sortDescriptor2 = [[NSSortDescriptor alloc] initWithKey:@"secretIdentity" ascending:YES selector:@selector(localizedCaseInsensitiveCompare:)];
        ...
        case kBySecretIdentity:{
            NSSortDescriptor *sortDescriptor1 = [[NSSortDescriptor alloc] initWithKey:@"secretIdentity" ascending:YES selector:@selector(localizedCaseInsensitiveCompare:)];
